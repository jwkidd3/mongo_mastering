...
totalCommands++; try { var verifyDelete = db.policies.find({premiumAmount: {$lt: 100}}).count(); print("✅ Verify deletion worked"); passedCommands++; } catch (error) { print("❌ Verify deletion worked - ERROR: " + error.message); errors.push("Lab5 verifyDelete: " + error.message); failedCommands++; }
