...
var policy1 = {_id: ObjectId(), policyNumber: "POL-AUTO-001", name: "Premium Auto Coverage", policyType: "Auto", customerId: "CUST000001", agentId: "AGT001", annualPremium: 1299.99, coverageDetails: {liability: "250000/500000", collision: {deductible: 500, coverage: "Full"}, comprehensive: {deductible: 250, coverage: "Full"}}, coverageTypes: ["liability", "collision", "comprehensive"], isActive: true, createdAt: new Date("2024-01-15"), expirationDate: new Date("2025-01-15")};
var policy2 = {_id: ObjectId(), policyNumber: "POL-HOME-001", name: "Homeowners Protection", policyType: "Property", customerId: "CUST000002", agentId: "AGT001", annualPremium: 1899.99, coverageDetails: {dwelling: {coverage: 400000, deductible: 1000}, personalProperty: {coverage: 200000, deductible: 500}, liability: 300000}, coverageTypes: ["dwelling", "personal_property", "liability"], isActive: true, createdAt: new Date("2024-02-01"), expirationDate: new Date("2025-02-01")};
var policy3 = {_id: ObjectId(), policyNumber: "POL-LIFE-001", name: "Term Life Insurance", policyType: "Life", customerId: "CUST000005", agentId: "AGT002", annualPremium: 599.99, coverageDetails: {deathBenefit: 500000, term: "20 years", cashValue: "standard", beneficiaries: "Spouse and Children"}, coverageTypes: ["death_benefit", "accidental_death"], isActive: true, createdAt: new Date("2024-03-01"), expirationDate: new Date("2044-03-01")};
var policy4 = {_id: ObjectId(), policyNumber: "POL-AUTO-002", name: "Standard Auto Coverage", policyType: "Auto", customerId: "CUST000004", agentId: "AGT004", annualPremium: 899.99, coverageDetails: {liability: "100000/300000", collision: {deductible: 1000, coverage: "Limited"}}, coverageTypes: ["liability", "collision"], isActive: true, createdAt: new Date("2024-01-20"), expirationDate: new Date("2025-01-20")};
var policy5 = {_id: ObjectId(), policyNumber: "POL-COMM-001", name: "Business Liability", policyType: "Commercial", customerId: "CUST000003", agentId: "AGT002", annualPremium: 2499.99, coverageDetails: {generalLiability: 2000000, productLiability: 1000000, businessType: "Technology"}, coverageTypes: ["general_liability", "product_liability"], isActive: true, createdAt: new Date("2024-02-10"), expirationDate: new Date("2025-02-10")};
var policy6 = {_id: ObjectId(), policyNumber: "POL-AUTO-003", name: "Economy Auto Coverage", policyType: "Auto", customerId: "CUST000006", agentId: "AGT006", annualPremium: 649.99, coverageDetails: {liability: "50000/100000"}, coverageTypes: ["liability"], isActive: false, createdAt: new Date("2023-12-01"), expirationDate: new Date("2024-12-01")};
var policy7 = {_id: ObjectId(), policyNumber: "POL-CYBER-001", name: "Cyber Security Protection", policyType: "Cyber", customerId: "CUST000007", agentId: "AGT003", annualPremium: 3299.99, coverageDetails: {dataBreachCoverage: 5000000, businessInterruption: 2000000, cyberExtortion: 1000000}, coverageTypes: ["data_breach", "business_interruption", "cyber_extortion"], isActive: true, createdAt: new Date("2024-03-15"), expirationDate: new Date("2025-03-15")};
var policy8 = {_id: ObjectId(), policyNumber: "POL-HEALTH-001", name: "Group Health Plan", policyType: "Health", customerId: "CUST000008", agentId: "AGT005", annualPremium: 8999.99, coverageDetails: {medicalCoverage: "Comprehensive", dentalCoverage: "Basic", visionCoverage: "Standard"}, coverageTypes: ["medical", "dental", "vision"], isActive: true, createdAt: new Date("2024-01-01"), expirationDate: new Date("2025-01-01")};
var policy9 = {_id: ObjectId(), policyNumber: "POL-PROP-002", name: "Commercial Property", policyType: "Property", customerId: "CUST000009", agentId: "AGT003", annualPremium: 4599.99, coverageDetails: {buildingCoverage: 2000000, equipmentCoverage: 500000, businessPersonalProperty: 300000}, coverageTypes: ["building", "equipment", "business_property"], isActive: true, createdAt: new Date("2024-02-20"), expirationDate: new Date("2025-02-20")};
var policy10 = {_id: ObjectId(), policyNumber: "POL-LIFE-002", name: "Whole Life Insurance", policyType: "Life", customerId: "CUST000011", agentId: "AGT005", annualPremium: 1299.99, coverageDetails: {deathBenefit: 250000, cashValue: "Accumulating", term: "Lifetime"}, coverageTypes: ["death_benefit", "cash_value"], isActive: true, createdAt: new Date("2024-03-10"), expirationDate: new Date("2074-03-10")};
...
// Policy-customer and policy-agent relationship indexes (for Day 2 $lookup operations)
